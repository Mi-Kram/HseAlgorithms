...
x1, y1 = readData("Merge_Insertion_Sort/data1.txt")
x2, y2 = readData("Merge_Insertion_Sort/data2.txt")
x3, y3 = readData("Merge_Insertion_Sort/data3.txt")
...
plt.title("Время работы алгоритма MergeSort+InsertionSort")
