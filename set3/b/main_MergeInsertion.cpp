...
const int N = 10'000, K = 10, M = 30;

int main() {
  calcSort(checkSort_Random,       "../b/Merge_Insertion_Sort/data1.txt");
  calcSort(checkSort_Sorted,       "../b/Merge_Insertion_Sort/data2.txt");
  calcSort(checkSort_AlmostSorted, "../b/Merge_Insertion_Sort/data3.txt");
